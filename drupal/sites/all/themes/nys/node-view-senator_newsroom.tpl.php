  ...
  <div style="clear:both"></div><div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"><div class="node-inner">
    <div class="committee-updates-description">
      ...
      <div class="content">
        ...
        <?php elseif (isset($node->field_feature_image) && $node->field_feature_image['0']['filepath']): ?>
          <div class="featured_image">
...
elseif (($teaser && ($node->type == 'event' ))): ?>
  <div style="clear:both"></div><div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"><div class="node-inner">
    <div class="committee-updates-description">
      ...
      <?php endif; ?>
      <div class="content">
        <?php if ($node->field_video[0]['embed'] && $node->field_video[0]['provider'] != 'livestream'): // teasers have inline display of all video except livestream ?>
          <div class="featured_image">
            <?php
              $field_type = 'field_video';
              $system_types = _content_type_info();
