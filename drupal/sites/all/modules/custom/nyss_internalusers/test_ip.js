...
{
  $('#block-nyss_blocks-live_session .block-inner > h2.block_title').html(json.headline);
  $('#block-nyss_blocks-live_session .block-inner .senate-status-message').html(json.message);
  if (json.display_video) {
    if (json.internal) {
